...
public class GUIStats : MonoBehaviour
{
    ...
    void StatsWindowHandle(int windowID)
    {
        ...
        GUI.Label(new Rect(_hi, _vi + 8 * _vs, _width, _height), "- Timer: " + player.leftRotationsCurrentEpoch, _styleWhite);//, "box");
        ...
        GUI.Label(new Rect(_hi, _vi + 18 * _vs, _width, _height), "- Timer: " + player.leftRotationsCurrentEpoch, _styleWhite);//, "box");
