...
public class GUIStats : MonoBehaviour
{
    ...
    void StatsWindowHandle(int windowID)
    {
        ...
        GUI.Label(new Rect(_hi, _vi, 200, 100), "Number of celestial bodies: " + _totalBodies, _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 1 * _vs, 200, 100), "Number of red bodies: " + _redBodies, _styleRed);//, "box");
        ...
        GUI.Label(new Rect(_hi, _vi + 7 * _vs, 200, 100), "[C] - Create bodies", _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 8 * _vs, 200, 100), "[X] - Save config", _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 9 * _vs, 200, 100), "[Z] - Open config", _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 10 * _vs, 200, 100), "[S] - Start simulation", _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 11 * _vs, 200, 100), "[A] - Pause simulation", _styleWhite);//, "box");
        GUI.Label(new Rect(_hi, _vi + 12 * _vs, 200, 100), "[D] - Reset simulation", _styleWhite);//, "box");
    }
}